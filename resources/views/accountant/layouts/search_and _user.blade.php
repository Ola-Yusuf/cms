        ...
        <div class="dropdown-menu dropdown-menu-end"
          ...
          <ul class="list-unstyled">
            ...
            <li>
              ...
              <li>
                <a class="dropdown-item" href="{{ route('accountant.login') }}">
                  <i class="me-2 icon-xxs dropdown-item-icon"
                    data-feather="settings"></i>{{ __('Login') }}
                </a>
              </li>
              @if (Route::has('accountant.register'))
                  <li>
                    <a class="dropdown-item" href="{{ route('accountant.register') }}">
                      <i class="me-2 icon-xxs dropdown-item-icon"
          ...
          @else
          <li>
            <a class="dropdown-item" href="{{ route('accountant.logout') }}"
